function Masthead() {
    return (
        <div className="masthead-container green">
                ...
                <div className="wrapper-inner topbottom masthead-container--content">
                    <div className="content left">
                        ...
                        <p>
                            ...
                            Help company, personal and community to build their digital product.
                        </p>
                        <div className="social-list">
                            <div className="social-list--item">
                                <a className="btn yellow outline light" href="https://www.linkedin.com/in/mridwanzalbina/" target="_blank"><i className="icon-ln    bi bi-linkedin"></i>&nbsp;&nbsp;Linkedin</a>
                                <a className="btn yellow outline light" href="https://instagram.com/ridwanzal" target="_blank"><i className="icon-ig bi bi-instagram"></i>&nbsp;&nbsp;Instagram</a>
                                <a className="btn yellow outline light" href="https://www.behance.net/ridwanzal" target="_blank">
